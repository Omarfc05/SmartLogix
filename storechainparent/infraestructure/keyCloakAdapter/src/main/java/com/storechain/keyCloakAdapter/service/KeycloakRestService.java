package com.storechain.keyCloakAdapter.service;
...
public class KeycloakRestService {
    ...
    public String login(String username, String password) {
        ...
        return restTemplate.postForObject("http://localhost:8091/realms/PaymentChain/protocol/openid-connect/token", request, String.class);
    }
